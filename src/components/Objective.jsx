...
const Objective = () => (
    <section className="bg-[#F6F6F6] px-[10%] py-10 text-[000]">
            ...
            {/* <div></div> */}
                ...
                <img src={star} alt="" />
                <p className="text-uppercase text-red text-[52px] font-san px-2">GOALS AND OBJECTIVES</p>
                <img src={star} alt="" />
                </div>
                {/* <div>b</div> */}
            </div>
    ...
    >
      <SwiperSlide>
        <img src={product1} alt="" className=" h-[481px] w-[797px]"/>
        </SwiperSlide>
      <SwiperSlide>
      <img src={product2} alt="" className=" h-[481px] w-[797px]"/>
        </SwiperSlide>
      <SwiperSlide>
      <img src={product3} alt="" className=" h-[481px] w-[797px]"/>
        </SwiperSlide>
        <SwiperSlide>
      <img src={product4} alt="" className=" h-[481px] w-[797px]"/>
        </SwiperSlide>
    </Swiper>
                {/* end carossel */}
                <div className="flex-row">
                    ...
                    <p className="font-normal text-[24px] w-[519px] text-center">Taking the lead in empowering the people of Zamfara, fostering a prosperous and vibrant community through inclusive opportunities and sustainable development.</p>
                </div>
            </div>
            ...
            <div className="flex items-center justify-center pb-5 pt-10">
                    ...
                    <div className="text-left font-normal text-[28px]">
